...
#ifdef OPLUS_FEATURE_WIFI_ROUTER_FRIEND
#fangbinghua@CONNECTIVITY.WIFI.HARDWARE.POWER, 2025/04/12, add for wifi routerfriend feature
function probe_gateway() {
    local gw=`getprop vendor.wifi.gw`
    /odm/bin/curl $gw
}
#endif /* OPLUS_FEATURE_WIFI_ROUTER_FRIEND */
